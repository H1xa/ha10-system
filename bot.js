...
client.on('ready',  () => {
    console.log('تم تشغيل : Ha10 System  ');
...
client.on('message', message => {
    ...
    .setAuthor("[ Ha10 System Bot ]", " https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455")
    .addField("**[ Ha10 System Prefix] :**","**[ + ]**" , true)
    .addField("** [ Ha10 System ID ] **", "**"+"459725014237970492"+"**",true)
    .addField("** [ Ha10 System ] **","** Rqmz Huxa**")
    ...
    .setColor("ffffff")
    .setFooter(`+help to see all Ha10 System commands `, ' https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455')
    message.channel.sendEmbed(embed)
    }
    });

client.on("guildDelete", guild => {
    console.log(` Ha10 System Left From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  Ha10 System™ `)
                .setTitle(" Ha10 System Left Server !")
...
console.log(` Ha10 System Added From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  Ha10 System™ `)
                .setTitle(" Ha10 System Added To Server !")
                .addField("**Guild Name:**", guild.name )
                 .addField("**Owner:**", guild.owner.user.username )
                 .addField("**MEMBER COUNT:**", g )
                  .setThumbnail (i)
